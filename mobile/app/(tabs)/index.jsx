        ...
        >
          <View style={styles.welcomeCard}>
            {currentUser?.profileImage || currentUser?.image ? (
              <Image
                source={{ uri: currentUser.profileImage || currentUser.image }}
              ...
              <View style={styles.statsRow}>
                ...
                <View style={styles.statCard}>
                  <Text
                    style={[
                      styles.statValue,
                      dashboardStats.lowStockItems > 0 && styles.warningValue,
                    ]}
                  >
          ...
          <LineChart
            ...
            bezier
            style={[styles.chart, { marginBottom: 16, marginLeft: -16 }]}
