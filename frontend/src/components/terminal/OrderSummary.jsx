  ...
  return (
    <div className="h-full bg-white rounded-[22px] border border-gray-200 flex flex-col" style={{ boxShadow: '5px 0 15px rgba(0,0,0,0.08), 0 7px 17px rgba(0,0,0,0.05)' }}>
      ...
      <div className="px-6 py-6 border-t bg-white">
        {/* Discount Section */}
        <div className="mb-6">
          <label className="block text-sm font-semibold text-[#8B7355] mb-2">Discount</label>
          <div className="flex items-center gap-2">
            <input
              type="text"
        ...
        <div className="space-y-2 mb-6 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-lg font-bold" style={{ color: 'rgba(255, 133, 88, 1)' }}>PHP {calculateTotal().toFixed(2)}</span>
          </div>
        </div>
        ...
        <div className="mb-6">
          <div className="flex gap-2 justify-center">
            ...
            >
              <img src={qrIcon} alt="QR Code" className="w-7 h-7 mb-1" />
