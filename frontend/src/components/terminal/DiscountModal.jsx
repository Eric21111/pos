      ...
      <div className={`rounded-2xl w-full max-w-md h-[95vh] flex flex-col shadow-2xl ${theme === 'dark' ? 'bg-[#1E1B18]' : 'bg-white'}`}>
        ...
        <div className={`px-6 py-4 border-b ${theme === 'dark' ? 'border-gray-700' : 'border-gray-200'}`}>
          <div className="flex items-center gap-4">
            ...
            <button className={`w-10 h-10 rounded-lg flex items-center justify-center border shadow-sm hover:shadow-md transition-shadow ${theme === 'dark' ? 'bg-[#2A2724] border-gray-600' : 'bg-white border-gray-200'}`}>
        ...
        <div className="flex-1 overflow-auto px-6 py-4">
          {loading ? (
            <div className="flex justify-center items-center py-12">
              <div className={theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}>Loading discounts...</div>
            </div>
            ...
            <div className="space-y-4">
              {filteredDiscounts.map((discount) => (
                ...
                >
                  ...
                  <div className={`flex-1 p-2 flex flex-col justify-between ${theme === 'dark' ? 'bg-[#2A2724]' : 'bg-white'}`}>
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-2 mb-1">
                        <div className="space-y-0.5">
                          <div className="flex items-center gap-1 text-[10px]">
                            ...
                            <span className={theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}>
                              Discount Value: <span className="font-bold" style={{ color: '#AD7F65' }}>{discount.discountValue}</span>
                            </span>
                          </div>
                          ...
                          <div className="flex items-center gap-1 text-[10px]">
                            ...
                            <span className={theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}>
                              Valid only from: <span className="font-bold" style={{ color: '#AD7F65' }}>
                        ...
                        <div className="space-y-0.5">
                          <div className="flex items-center gap-1 text-[10px]">
                            ...
                            <span className={theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}>
                              Applies to: <span className="font-bold" style={{ color: '#AD7F65' }}>{discount.appliesTo}</span>
                            </span>
                          </div>
                          ...
                          {discount.usage && (
                            <div className="flex items-center gap-1 text-[10px]">
                              ...
                              <span className={theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}>
                                Used: <span className="font-bold" style={{ color: '#AD7F65' }}>{discount.usage.used}/{discount.usage.total}</span> times
                              </span>
                            </div>
                          )}
                        </div>
                    ...
                    {discount.description && (
                      <div className="text-[10px] italic" style={{ color: '#AD7F65' }}>
                        {discount.description}
                      </div>
                    )}
                  </div>
