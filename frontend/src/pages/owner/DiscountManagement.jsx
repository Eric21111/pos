        ...
        <div className="flex items-center gap-2">
          <div className="relative" style={{ maxWidth: '400px' }}>
            ...
            <input
              ...
              className={`w-[500px] h-11 pl-14 pr-4 border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#AD7F65] focus:border-transparent ${theme === 'dark'
                ? 'bg-[#2A2724] border-gray-600 text-white placeholder-gray-400'
                : 'bg-white border-gray-300 text-gray-900'
                }`}
            />
          </div>
          <button className={`p-2 rounded-lg ml-23 ${theme === 'dark' ? 'hover:bg-[#3A3734]' : 'hover:bg-gray-100'}`}>
            <img src={filterIcon} alt="Filter" className={`w-5 h-5 opacity-90 ${theme === 'dark' ? 'brightness-0 invert' : ''}`} />
          </button>
        </div>
        <button
