        ...
        <div className="w-full max-w-[600px]">
          ...
          <div className={`flex items-start gap-12 transition-all duration-500 ${showKeypad ? 'justify-center' : 'justify-center'}`}>
            ...
            <div className={`flex flex-col items-center transition-all duration-500 ${showKeypad ? 'mt-10' : 'mt-0'}`}>
              ...
              <p className="text-xl font-semibold text-gray-800 mb-1" style={{ fontFamily: 'sans-serif' }}>Enter Your PIN</p>
              <p className="text-sm text-gray-600 mb-2" style={{ fontFamily: 'sans-serif' }}>Please enter your 6-digit PIN to continue</p>
              {error && (
                <p className="text-xs text-red-600 mb-4 text-center max-w-xs" style={{ fontFamily: 'sans-serif' }}>{error}</p>
              )}
              <p className="text-sm text-gray-600 mb-6" style={{ fontFamily: 'sans-serif' }}>PIN</p>
