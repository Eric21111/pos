...
const AddBrandModal = ({ visible, onClose, onAdd }) => {
    ...
    const handleSubmit = async () => {
        ...
        setIsLoading(true);
        try {
            const response = await brandPartnerAPI.create({ brandName: brandName.trim() });
            ...
            if (response.success) {
                ...
                Alert.alert('Error', response.message || 'Failed to add brand');
            }
        } catch (error) {
